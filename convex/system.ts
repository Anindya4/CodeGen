...
const validateInternalKey = (key: string) => {
  ...
  if (!internalKey)
    throw new Error("CODEGEN_CONVEX_INTERNAL_KEY is not configured");
...
// Used for Agent "CreateBulkFiles" tool
...
// Used by the Agent for "RenameFile" tool
...
// Used for agent for "DeleteFile" tool
