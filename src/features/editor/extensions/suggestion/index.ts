...
class SuggestionWidget extends WidgetType {
    ...
    toDOM(){
        ...
        span.style.pointerEvents = "none" //no clicking
        return span;
    }
...
const acceptSuggestionKeymap = keymap.of([
    {
        ...
        run: (view) => {
            ...
            return true; // no need to indent with tab just accept the suggestions
        }
    }
]);
...
export const suggestion = (fileName: string) => [
    ...
    createDebouncedPlugin(fileName), //triggers suggestions on typing.
    renderPlugin, //render the ghost texts.
    acceptSuggestionKeymap, //Tab to accept the suggested text
]
