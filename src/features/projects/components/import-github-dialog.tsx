    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the GitHub repository URL you want to import. A new project will be created after importing the repository. 
          </DialogDescription>
        </DialogHeader>
        <form
        onSubmit={(e) => {
          ...
          <form.Field name="url">
            {(field) => {
              ...
              <Field data-invalid={isInvalid}>
                ...
                placeholder="https://github.com/owener/repo"
                />
