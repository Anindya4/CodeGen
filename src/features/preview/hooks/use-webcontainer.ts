...
import { buildTreeFile, getFilePath } from "@/features/preview/utils/file-tree";
...
// singleton webcontainer instances
...
export const useWebContainer = ({
    ...
    //fetch files from Convex database (auto-updates on changes)
    ...
    useEffect(() => {
        ...
        const start = async () => {
            try {
                ...
                //parse install command (like `npm install`)
